...
(defn -main [& args]
  ...
  (println (save-user (user "firstuser" "xxxxx" "aaa" (md5 "pwd3")))) ; will not save duplicate
  (println (get-user-by-id "fake"))
  (println (get-user-by-id "firstuser"))
  (println (save-news (news nil "fake" "some text")))
  (println (save-news (news nil "firstuser" "some text")))
  (println (save-news (news nil "firstuser" "news two")))
  (println (get-news-by-id 1))
  (println (get-news-by-id 0))
  ;(init-id-seq)
